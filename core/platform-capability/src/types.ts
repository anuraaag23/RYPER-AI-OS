...
export interface CapabilityDescriptor {
  ...
  /**
   * Optional fine-grained operation-level capability requirements.
   * If specified for an operation, this overrides `requiredCapability` for that operation.
   * If unspecified for an operation, falls back to `requiredCapability`.
   */
  readonly operationCapabilities?: Readonly<Record<string, Capability>>;
