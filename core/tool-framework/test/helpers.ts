...
export function buildPluginRuntime(broker?: CapabilityBroker, eventBus?: EventBus): PluginRuntime {
  return new PluginRuntime(broker ?? buildCapabilityBroker(), eventBus ?? new EventBus(), true);
}
